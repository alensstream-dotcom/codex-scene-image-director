...
这是在 [智绘姬 st-chatu8](https://github.com/damoshen123/st-chatu8) 2.7.7 源码上制作的 Galgame 自动生图版。原作者的角色/服装管理、ComfyUI、自定义工作流、缓存和手机界面全部保留；新增的导演只在每轮回复结束时做一次快速全局分镜。
...
3. 正常聊天。导演会在回复结束后约 3–9 秒内把按钮插到对应剧情原位，并自动生成；DeepSeek 超过 9 秒会直接本地回退。

默认图像工作流为 JANIMA v10、768×1024、Euler、CFG 1、Turbo LoRA、8 步。普通女性剧情目标 3 个不同镜头，快节奏剧情 4–6 个；纯男性、纯场景、重复连续动作不会生图。人物外貌会锁定，服装只在剧情明确换装时更新。成人 NSFW 剧情不会被额外压制；涉及未成年人的性内容不会生成。
