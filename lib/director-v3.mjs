...
function actionTags(text = '', stage = '') {
    ...
    add(/纠正.*(?:握剑|姿势)|手.*覆.*手|握住.*手.*剑|guiding.*hand/i, 'female master guiding her disciple, hand over hand sword guidance, both hands holding the same wooden sword, close teaching interaction');
