...
const VISUAL_RE = /(?:走|跑|坐|站|跪|躺|推|拉|抱|吻|抓|握|拔|挥|劈|刺|练|舞|跳|回头|转身|探头|开门|递|喂|抚|摸|按|脱|穿|进入|抽动|高潮|弹琴|做饭|做鱼|烹鱼|烹饪|下厨|walk|run|sit|stand|kneel|lie|push|pull|embrace|kiss|grab|hold|draw|swing|stab|turn|peek|open|feed|touch|undress|penetrat|climax|play|cook)/i;
